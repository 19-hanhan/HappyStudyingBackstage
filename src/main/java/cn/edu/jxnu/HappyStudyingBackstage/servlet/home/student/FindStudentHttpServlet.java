...
@WebServlet(name = "FindStudentHttpServlet", value = "/FindStudentHttpServlet")
public class FindStudentHttpServlet extends HttpServlet {
    @Override
...
//        resp.setContentType("text/html; charset = UTF-8");
        ...
        List<Student> ls = service.findStudentByName(key);
