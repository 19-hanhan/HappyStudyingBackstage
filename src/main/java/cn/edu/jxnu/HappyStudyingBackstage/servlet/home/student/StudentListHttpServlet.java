...
@WebServlet(name = "StudentListHttpServlet", value = "/student_list.do")
public class StudentListHttpServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        map.put("list", ls);
        map.put("count", service.clacStudentCount());
