        ...
        if (ls_data.length > 0) {
            ls_data.map(function (item, index) {
                admin_list_html += '        <tbody>\n' +
                    '        <tr>\n' +
                    '            <td id="adminId">' + item.a_id + '</td>\n' +
                    '            <td>' + item.a_name + '</td>\n' +
                    '            <td>' + item.a_email + '</td>\n' +
                    '            <td class="td-manage">\n' +
                    '                <a title="编辑" onClick=\'javascript:window.open("/UpdateAdminServlet?id=' + item.a_id + '","","width=400,height=270,top=400,left=600,toolbar=no, status=no, menubar=no, resizable=no, scrollbars=no");return false;\'>\n' +
                    '                    <i class="layui-icon">&#xe642;</i>\n' +
                    '                </a>\n' +
                    '                <a onclick="delAdmin(this)" href="/OptAdminHttpServlet?id=' + item.a_id + '&opt=delete">\n' +
                    '                    <i class="layui-icon">&#xe640;</i>\n' +
                    '                </a>\n' +
                    '            </td>\n' +
                    '        </tr>\n' +
            ...
            if (ls_data.length > 0) {
                ...
                ls_data.map(function (item, index) {
                    ...
                    admin_list_html += '        <tbody>\n' +
                        ...
                        '                    <i class="layui-icon">&#xe642;</i>\n' +
                        '                </a>\n' +
                        '                <a href="/OptAdminHttpServlet?id=' + item.a_id + '&opt=delete" onclick="delAdmin(this)">\n' +
                        '                    <i class="layui-icon">&#xe640;</i>\n' +
                        '                </a>\n' +
                        '            </td>\n' +
                        '        </tr>\n' +
